    ...
    return (n, s) => (W(), q("div", on, [
      T("div", nn, [
        me(T("span", an, [
          T("button", {
            type: "button",
            class: "p-1.5 rounded-full bg-white text-vtd-secondary-600 transition-colors border border-transparent hover:bg-vtd-secondary-100 hover:text-vtd-secondary-900 focus:bg-vtd-primary-50 focus:text-vtd-secondary-900 focus:border-vtd-primary-300 focus:ring-3 focus:ring-vtd-primary-500/10 focus:outline-hidden",
              ...
              te(wt, {
                ...
                default: Ne(() => [
                  se(t)(h) || h.hovered() ? (W(), q("span", {
                    key: 0,
                    class: Te(["absolute bg-vtd-primary-100 bg-opacity-60", se(l)(h)])
                  }, null, 2)) : he("", !0)
                ]),
                _: 2
              }, 1024),
...
}, In = { class: "flex flex-wrap lg:flex-nowrap flex-row-reverse" }, Hn = { class: "relative flex flex-wrap sm:flex-nowrap p-1 w-full" }, Un = {
  key: 0,
...
}, Kn = { class: "px-0.5 sm:px-2" }, Gn = { key: 0 }, Zn = { class: "mt-2 mx-2 py-1.5 border-t border-black/[.1]" }, qn = { class: "mt-1.5 sm:flex sm:flex-row-reverse" }, Jn = ["disabled", "onClick", "textContent"], Xn = ["onClick", "textContent"], Qn = {
  key: 1,
  class: "sm:hidden"
}, ea = { class: "mt-2 mx-2 py-1.5 border-t border-black/[.1]" }, ta = { class: "mt-1.5 sm:flex sm:flex-row-reverse" }, oa = ["onClick", "textContent"], na = {
  key: 1,
  class: "flex"
}, aa = { class: "bg-white rounded-lg shadow-sm border border-black/[.1] px-3 py-3 sm:px-4 sm:py-4" }, ra = { class: "flex flex-wrap lg:flex-nowrap flex-row-reverse" }, sa = { class: "relative flex flex-wrap sm:flex-nowrap p-1 w-full" }, la = {
  key: 0,
  class: "hidden h-full absolute inset-0 sm:flex justify-center items-center"
}, ua = { class: "px-0.5 sm:px-2" }, ia = {
  key: 1,
  class: "relative w-full md:w-1/2 lg:w-80 overflow-hidden mt-3 sm:mt-0 sm:ml-2"
}, da = { class: "px-0.5 sm:px-2" }, ca = { key: 0 }, ma = { class: "mt-2 mx-2 py-1.5 border-t border-black/[.1]" }, fa = { class: "mt-1.5 sm:flex sm:flex-row-reverse" }, pa = ["disabled", "textContent"], va = /* @__PURE__ */ ue({
        ...
        T("div", ra, [
          ...
          T("div", sa, [
            b() && !t.asSingle ? (W(), q("div", la, c[7] || (c[7] = [
              T("div", { class: "h-full border-r border-black/[.1]" }, null, -1)
            ]))) : he("", !0),
            T("div", {
              ...
              default: Ne(({ close: i }) => [
                T("div", {
                  ...
                  T("div", {
                    ...
                    T("div", {
                      class: Te(["vtd-datepicker static sm:relative w-full bg-white sm:rounded-lg sm:shadow-sm border-0 sm:border border-black/[.1] px-3 py-3 sm:px-4 sm:py-4", Fe(m)])
                    }, [
                      T("div", In, [
                        t.shortcuts ? (W(), Ue(gt, {
                          key: 0,
